...
function Ticket() {
  ...
  const { tickets, inputMin, inputMax } = useTickets();
...
// updatedAirline[index].checked = value; คือการอัปเดตค่าของ checkbox ในตำแหน่งที่ระบุด้วย index เป็น value ที่เราได้รับจากการเปลี่ยนแปลงของ checkbox
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-y-10 bg-orange-100">
      <Search />
      <div className="grid grid-rows-1 grid-cols-3 gap-1 max-w-[70vw] my-auto h-screen">
        <div className="">
        ...
        <div className="col-span-2 overflow-y-auto overflow-x-hidden h-[80vh] on-scrollbar">
          {ticketItem.map((item) => {
