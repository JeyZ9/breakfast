...
function Booking() {
  const { id } = useParams();
  const { tickets, formatDateTime } = useTickets()
    ...
    {ticket && (
      <div className="grid grid-cols-3 gap-5">
        <div className="col-span-2">
          ...
          <div className="px-5 py-5 text-sm flex justify-between font-medium">
            ...
            <div className="flex items-center justify-center">
              <button onClick={() => backPage()} className="border border-red-300 rounded-md text-red-300 px-4 py-1 hover:border-red-500 hover:text-red-500 delay-500 duration-500 ease-linear">Change</button>
            </div>
        ...
        <div className="flex flex-col justify-between p-5 gap-3">
          ...
          <Link to={`/tickets/booking/${ticket.ticketId}/${ticket.flight.origin.city}/${ticket.flight.destination.city}/checkout`} className="items-center text-center">
